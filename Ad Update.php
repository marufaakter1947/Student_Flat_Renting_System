                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <select name="location">
                                        <option value="Boyra"<?php if ($_SESSION["location"] === 'Boyra') {echo 'selected';} ?>> Boyra </option>
                                        <option value="Sonadanga"<?php if ($_SESSION["location"] === 'Sonadanga') {echo 'selected';} ?>> Sonadanga </option>
                                        <option value="ShantiDham"<?php if ($_SESSION["location"] === 'ShantiDham') {echo 'selected';} ?>> ShantiDham </option>
                                        <option value="Shib Barir Mor"<?php if ($_SESSION["location"] === 'Shib Barir Mor') {echo 'selected';} ?>> Shib Barir Mor </option>
                                        <option value="New Market"<?php if ($_SESSION["location"] === 'New Market') {echo 'selected';} ?>> New Market </option>
                                    </select>
                                </div>
                            </div>
